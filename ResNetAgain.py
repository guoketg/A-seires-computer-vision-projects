...
#             blk.append(Residual(in_channels,num_channels,use_1x1_conv=True,strides=2))
#         else:
#             blk.append(Residual(num_channels,num_channels))
#     return blk

#修改为正确的resnet_block
# def resnet_block(in_channels,num_channels,residual_num,first_block=False):
#     blk=[]
